...
st.set_page_config(page_title="QuantumDocs - OCR Boosted", layout="wide")
st.title("QuantumDocs")
st.subheader("Improved OCR with Image Preprocessing (OpenCV)")
...
if uploaded_file:
    ...
    if "pdf" in file_type:
        ...
        raw_text = "\n".join(reader.readtext(proc, detail=0))
    ...
    with col2:
        st.markdown("### Extracted Fields (Improved)")
